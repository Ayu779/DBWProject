...
session_start();
	...
	$z=$_SESSION["Email"];
    $total=0;
	$query="select * from cart where Email = '$z';";
		$result=mysqli_query($conn,$query);
		if(!$result)
		{
		echo "<html><script>alert('Cart empty!!!')</script></html>";}
		else
        {
while($e=mysqli_fetch_array($result))
{
	echo"<div class='box'>";
echo "<b>Dish Name: </b>".$e['cname']."<br><b>Price: </b>".$e['cprice']."<br>";
$s1=$e['cname'];
$s2=$e['cprice'];
$total = $total + $e['cprice'];
...
echo "<div class='box'><strong><b>Total Price: </strong></b></div>".$total;
